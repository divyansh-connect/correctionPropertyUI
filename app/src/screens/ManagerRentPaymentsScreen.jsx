          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <ScrollView style={styles.modalForm} showsVerticalScrollIndicator={false}>
                ...
                <TextInput
                  style={[styles.formInput, { backgroundColor: '#0f172a', color: '#94a3b8' }]}
                  editable={false}
...
const styles = StyleSheet.create({
  ...
  // Ledger elements
  ledgerDesc: { fontSize: 12.5, color: '#94a3b8', marginTop: 6 },
  ledgerGrid: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
  ledgerGridItem: { flex: 1, alignItems: 'flex-start' },
  ledgerGridLabel: { fontSize: 8.5, fontWeight: '800', color: '#64748b', letterSpacing: 0.5 },
  ...
  formLabel: { fontSize: 9.5, fontWeight: '800', color: '#94a3b8', letterSpacing: 0.8, marginTop: 10, marginBottom: 4 },
  formInput: {
    backgroundColor: '#0f172a',
    borderRadius: 10,
    padding: 10,
  ...
  subtotalLabel: { fontSize: 12, color: '#94a3b8' },
  subtotalVal: { fontSize: 12, color: '#f8fafc', fontWeight: '700' },
  totalLabel: { fontSize: 13, color: '#f8fafc', fontWeight: '800' },
  ...
  stmtCompanyName: { fontSize: 14.5, fontWeight: '800', color: '#f8fafc' },
  stmtCompanyAddress: { fontSize: 10.5, color: '#94a3b8' },
  stmtRecipientBox: { alignItems: 'flex-end', flex: 1, marginLeft: 8 },
  stmtRecipientLabel: { fontSize: 8, fontWeight: '800', color: '#64748b', letterSpacing: 0.5, marginBottom: 3 },
  stmtRecipientName: { fontSize: 13, fontWeight: '800', color: '#f8fafc' },
  stmtRecipientContact: { fontSize: 10, color: '#94a3b8' },
  stmtRecipientLocation: { fontSize: 10, color: '#cbd5e1', fontWeight: 'bold', marginTop: 2 },
  stmtTableContainer: {
    backgroundColor: '#0f172a',
    borderRadius: 12,
    borderWidth: 1,
  ...
  stmtTableHeaderCol: { fontSize: 8.5, fontWeight: '800', color: '#94a3b8', letterSpacing: 0.5 },
  stmtTableRow: {
    flexDirection: 'row',
    paddingVertical: 10,
    paddingHorizontal: 8,
  ...
  stmtTableColText: { fontSize: 10.5, color: '#cbd5e1' },
  stmtFooterRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  stmtGeneratedText: { fontSize: 9.5, color: '#64748b' },
  stmtOutstandingLabel: { fontSize: 8, fontWeight: '800', color: '#94a3b8', letterSpacing: 0.5 },
